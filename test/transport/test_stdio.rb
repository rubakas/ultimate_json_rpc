...
class TestStdio < Minitest::Test
  ...
  def test_stop_on_unstarted_adapter_is_noop
    adapter = UltimateJsonRpc::Transport::Stdio.new(@server, input: StringIO.new(""), output: StringIO.new)
  ...
  def test_running_is_false_after_run_completes
    ...
    adapter = UltimateJsonRpc::Transport::Stdio.new(@server, input: input, output: output)
    adapter.run
  ...
  def test_epipe_on_output_stops_gracefully
    ...
    adapter = UltimateJsonRpc::Transport::Stdio.new(@server, input: input, output: broken_output)
