...
class TestResponseSuccess < Minitest::Test
  def test_success_structure
    response = UltimateJsonRpc::Core::Response.success("ok", 1)
  ...
  def test_success_with_nil_result
    response = UltimateJsonRpc::Core::Response.success(nil, 1)
  ...
  def test_success_with_null_id
    response = UltimateJsonRpc::Core::Response.success("ok", nil)
...
class TestResponseError < Minitest::Test
  def test_error_structure
    response = UltimateJsonRpc::Core::Response.error(UltimateJsonRpc::Core::METHOD_NOT_FOUND, 1)
  ...
  def test_error_with_custom_message
    response = UltimateJsonRpc::Core::Response.error(UltimateJsonRpc::Core::INTERNAL_ERROR, 1, message: "custom")

    assert_equal "custom", response["error"]["message"]
  end

  def test_error_with_data
    response = UltimateJsonRpc::Core::Response.error(UltimateJsonRpc::Core::INTERNAL_ERROR, 1, data: "details")

    assert_equal "details", response["error"]["data"]
  end

  def test_error_without_data_omits_key
    response = UltimateJsonRpc::Core::Response.error(UltimateJsonRpc::Core::INTERNAL_ERROR, 1)
  ...
  def test_error_with_zero_data_includes_key
    response = UltimateJsonRpc::Core::Response.error(UltimateJsonRpc::Core::INTERNAL_ERROR, 1, data: 0)

    assert_equal 0, response["error"]["data"]
  end

  def test_error_with_null_id
    response = UltimateJsonRpc::Core::Response.error(UltimateJsonRpc::Core::PARSE_ERROR, nil)
  ...
  def test_error_unknown_code_uses_fallback_message
    response = UltimateJsonRpc::Core::Response.error(999, 1)
